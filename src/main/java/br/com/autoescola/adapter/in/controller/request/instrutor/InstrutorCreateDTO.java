...
public record InstrutorCreateDTO(
                // @NotBlank serve para null e "", é mais que @NotNull ent, recomendado para
                // Strings
                ...
                // "\\d{2}/\\{2}/\\d{4}" = campo numerico com 2 algarismos/campo numerico com 2
                // algarismos/campo numerico com 4 algarismos
